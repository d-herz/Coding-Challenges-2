...
//PREP
//P: x, a number or a string (if a string, convert to number value)
//R: check if x^2 is > 1000. If so, retrun string 1, else return string 2
//E: apple(50) -> (50^2 = 2500) ans = "string 1"
/****P: apple(x){
  square the value of x
  check if greater or less than 1000
