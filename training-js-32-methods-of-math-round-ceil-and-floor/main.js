...
//P: a number with a decimal
//R: the number, rounded depending on initial decimal placement
//E: rountIt(3.45) === 4 () 
/* (decimal on left side, Math.ceil()), (decimal on right, Math.floor()), (if decimal in middle, use Math.round())
*/
//
