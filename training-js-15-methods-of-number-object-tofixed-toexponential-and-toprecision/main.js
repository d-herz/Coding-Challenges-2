...
//PREP
//P: an array of decimal numbers, and an integer n
//R: return the array with 2 decimal points and a number 
//E: howManySmaller([1.234,1.235,1.228],1.24) === 2
/*P:
  function howManySmaller(arr,n){
  iterate through array and change sig. figs.
  then return how many elements are smaller than n
  }
*/
